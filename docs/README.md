...
- [create-app](./tasks/creators/create-app.md)
- [create-babelrc](./tasks/creators/create-babelrc.md)
- [create-contributing](./tasks/creators/create-contributing.md)
- [create-database-rules-json](./tasks/creators/create-database-rules-json.md)
- [create-dev-config](./tasks/creators/create-dev-config.md)
...
- [remove-fragment](./tasks/removers/remove-fragment.md)
- [remove-hosting-header](./tasks/removers/remove-hosting-header.md)
- [remove-hosting-rewrite](./tasks/removers/remove-hosting-rewrite.md)
- [remove-route](./tasks/removers/remove-route.md)

## setters

- [set-analytics](./tasks/setters/set-analytics.md)
- [set-app-config](./tasks/setters/set-app-config.md)
- [set-app-description](./tasks/setters/set-app-description.md)
- [set-app-image](./tasks/setters/set-app-image.md)
- [set-app-short-title](./tasks/setters/set-app-short-title.md)
- [set-app-title](./tasks/setters/set-app-title.md)
- [set-app-twitter-handle](./tasks/setters/set-app-twitter-handle.md)
- [set-base-href](./tasks/setters/set-base-href.md)
- [set-database](./tasks/setters/set-database.md)
- [set-drawer](./tasks/setters/set-drawer.md)
- [set-firebase-config](./tasks/setters/set-firebase-config.md)
- [set-firebase-version](./tasks/setters/set-firebase-version.md)
- [set-fragment](./tasks/setters/set-fragment.md)
- [set-header](./tasks/setters/set-header.md)
- [set-hosting-header](./tasks/setters/set-hosting-header.md)
